# Contributing to dts-minify-lite
...
1. **Reporting Bugs**: If you find a bug, please report it by [creating an issue](https://github.com/felixicaza/dts-minify-lite/issues). Each package has a label to easily identify which package the issue corresponds to, so please use the appropriate labels.
2. **Suggesting Features**: If you have an idea for a new feature, please open an [discussion](https://github.com/felixicaza/dts-minify-lite/discussions).
...
2. **Clone your fork**:
    ```sh
    git clone https://github.com/yourusername/dts-minify-lite.git
    ```
...
If you encounter any issues while using the plugins, please report them by [creating an issue](https://github.com/felixicaza/dts-minify-lite/issues) in the repository. Provide as much detail as possible to help us understand and resolve the issue quickly.
